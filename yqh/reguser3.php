...
if(empty($mb)){
 ...
 echo "0#fail";
  ...
  insertuserinfo($uid,$mobile,$username,$smscodes,$pwd,$device,$deviceid); 
...
function insertuserinfo($uid,$mobile,$username,$smscodes,$pwd,$device,$deviceid){
//地址
$url = "120.131.70.218";
//账号
$user = "root";
...
$sql = "insert into userinfo (uid,mobilenum,username,smscodes,password,device,deviceid)  values('$uid','$mobile','$username','$smscodes','$pwd','$device','$deviceid')";
