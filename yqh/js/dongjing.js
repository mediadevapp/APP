 var selector = ".page";
    ...
    var images = [
            "./img/dongjing/1.jpg",
            "./img/dongjing/1-1.png",
            "./img/dongjing/1-10.png",
            "./img/dongjing/1-11.png",
            "./img/dongjing/1-12.png",
            "./img/dongjing/1-13.png",
            "./img/dongjing/1-14.png",
            "./img/dongjing/1-15.png",
            "./img/dongjing/1-16.png",
            "./img/dongjing/1-2.png",
            "./img/dongjing/1-3.png",
            "./img/dongjing/1-4.png",
            "./img/dongjing/1-5.png",
            "./img/dongjing/1-6.png",
            "./img/dongjing/1-7.png",
            "./img/dongjing/1-8.jpg",
            "./img/dongjing/1-9.png"];
