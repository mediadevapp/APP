...
&& ($_FILES["file"]["size"] < 50000000))
  ...
  if ($_FILES["file"]["error"] > 0)
    ...
    if (file_exists("pics/" . $_FILES["file"]["name"]))
      ...
      $_picpath = "http://120.131.70.218/" . "pics/" . $_FILES["file"]["name"];  

      
      uploadpic($eid,$title,$ucontent,$_picpath);
...
function uploadpic($eid,$title,$content,$path){
...
$sql = "insert into eventsinfo (eid,title,content,pics)values('$eid','$title','$content','$path')";
