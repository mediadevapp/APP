...
class DB {
    ...
    public function __construct() {
        ...
        $this->connect("120.131.70.218", "root", "1q2w3e4r5t6yJUSHI$", "star_app", "1");
    ...
    public function connect($dbhost, $dbuser, $dbpw, $dbname, $pconnect = 0, $charset ='utf8') {
        if($pconnect == 0){
            $this->link_id = mysql_pconnect("120.131.70.218", "root", "1q2w3e4r5t6yJUSHI$", true);
            
            if(!$this->link_id){
                $this->halt("数据库连接失败");    
            }
        }else{
            $this->link_id = mysql_pconnect("120.131.70.218", "root", "1q2w3e4r5t6yJUSHI$");
            if(!$this->link_id){
                $this->halt("数据库长连接失败");
            }
        }
